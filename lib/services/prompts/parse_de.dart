...
- DHA: SCHÄTZE dha_mg immer, sobald eine echte DHA-Quelle in der Mahlzeit ist, nach diesen Ankern und rechne die Werte NICHT klein: fetter Seefisch (Lachs 1100-1400, Hering 1500-2000, Makrele 1100-1300, Sardine 900-1100 mg/100 g - ein 150-g-Lachsfilet liefert also weit über 1000 mg, nicht ein paar hundert), Eigelb 30-40 mg pro ganzem Ei (Eiklar allein nahe null), Fischöl-/Algenöl-Supplement laut Angabe. Ein Hühnerei in JEDER Form (gekocht, Rührei, Spiegelei, pochiert, im Gericht) ist eine echte DHA-Quelle und zählt IMMER mit ~35 mg DHA pro Ei, niemals weglassen. dha_mg NUR komplett weglassen, wenn die Mahlzeit KEINE dieser Quellen enthält, also bei magerem Fleisch, magerem Fisch und rein pflanzlichen Mahlzeiten. Pflanzliche Omega-3-Quellen (Leinsamen, Chia, Walnüsse, Mandeln, Rapsöl, Sojaöl) enthalten ALA (Vorstufe), NICHT DHA - die Konversion ALA→DHA im Körper liegt unter 5% und wird NICHT als DHA mitgezählt.
...
WICHTIG: Schätze die Mikronährstoffe für JEDES erkennbare Lebensmittel aktiv aus üblichen Nährwerten. Nutze die Anker oben als Orientierung, auch wenn das genaue Lebensmittel dort nicht namentlich steht (z.B. Haferflocken, Quinoa, Hirse, Amaranth liefern wie anderes Vollkorn Eisen; behandle sie so). Lass einen Key NUR weg, wenn der Beitrag DIESER Mahlzeit wirklich unter ~5% der Tagesreferenz (DGE 2025) liegt - nicht „im Zweifel weglassen", sondern nur bei echtem Unter-5%. Erfinde umgekehrt keine Nährstoffe, die das Lebensmittel nicht enthält (kein DHA bei Pflanzen, kein B12 bei rein pflanzlichen Mahlzeiten). Bei einer Mahlzeit ganz ohne nennenswerte Mikronährstoffe (z.B. Wasser, reiner Zuckerdrink) das gesamte micronutrients-Feld weglassen. Werte sind pro DIESE Mahlzeit, nicht pro 100g.
