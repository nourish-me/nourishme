...
- DHA: fetter Seefisch (Lachs 1100-1400, Hering 1500-2000, Makrele 1100-1300, Sardine 900-1100 mg/100 g), Eigelb 30-40 mg/Stück. Mageres Fleisch, Pflanzen, magerer Fisch nahe null. STRIKTE DHA-NULLREGEL: Wenn die Mahlzeit KEINEN fetten Seefisch (Lachs/Hering/Makrele/Sardine/Sardelle/Thunfisch), KEIN Ei bzw. Eigelb, KEIN Fischöl-Supplement und KEIN Algenöl enthält, dann ist dha_mg = 0 und der Key wird komplett WEGGELASSEN. Eier sind eine echte DHA-Quelle: rechne pro ganzem Ei (mit Eigelb) 30-40 mg DHA, Eiklar allein nahe null. Pflanzliche Omega-3-Quellen (Leinsamen, Chia, Walnüsse, Mandeln, Rapsöl, Sojaöl) enthalten ALA (Vorstufe), NICHT DHA - die Konversion ALA→DHA im Körper liegt unter 5% und wird NICHT als DHA mitgezählt.
