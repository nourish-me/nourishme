...
// Theme builders. Text styles live in nourishme_type.dart (the seven-token
// system). AppBar uses titleLarge by default (SF Pro 22/600). Brand-y screens
// can opt into displaySmall (Newsreader italic) per-Text where appropriate.
ThemeData buildLightTheme() {
  final scheme = _light;
  final text = appTextTheme(scheme);
  return ThemeData(
    useMaterial3: true,
    colorScheme: scheme,
