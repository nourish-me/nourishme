...
- [x] **Confirm-Screen Datum/Zeit beim Nachtragen** · Lotte (1) · #P2 · ✅ tester-bestätigt 2026-06-22 (bereits ausgelieferter Picker-Rework) · [[beta-feedback-log#2026-06-21 · Lotte (T11) · current beta · WhatsApp|→ Log]]
	Lotte fand den Datum-Chip wie einen Pflicht-Schritt und die Zeiten beim Nachtragen „wild". Auf Rückfrage (2026-06-22) per Video + „mit Datum und Zeit ist jetzt schon viel besser mit dem neuen view :)" bestätigt: der bereits ausgelieferte Confirm-Sheet-Picker-Rework (CupertinoDatePicker, kombiniertes Rad) löst beides. Video zeigt einen vergangenen Tag mit sauberen Zeitstempeln (17:40 Pizza) in korrekter Reihenfolge. Das „wilde" Durcheinander war die nicht gesetzte Zeit, im neuen View setzt sie Datum+Zeit und es stimmt. Kein weiterer Bau nötig, der geplante „Datum bei heute nicht interaktiv"-Fix entfällt (Einzelstimme, jetzt zufrieden). · Isabella + Julia (2) · #P1 · ✅ +36 · [[beta-feedback-log#2026-06-11 · Isabella Hoesch (T8) · TestFlight v18 · Screenshots|→ Log]]
